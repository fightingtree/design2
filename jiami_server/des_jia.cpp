#include "des_jia.h"
#include "ui_des_jia.h"
#include <QFile>
#include <QFileDialog>
DES_jia::DES_jia(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::DES_jia)
{
    ui->setupUi(this);
    ...
    ui->keyword->setPlaceholderText("8 Byte");
...
void DES_jia::on_decrption_clicked()
{
    if(NULL == tcpSocket){
        return;
    }
    ...
    QString cmd = "./des 2 "+ui->keyword->text()+" "+str;
    //qDebug()<<cmd;
    process->start(cmd);
    out=tr("");
...
void DES_jia::change(int i){
    flag = i ;
}

void DES_jia::on_inFile_clicked()
{
...
void DES_jia::on_outFile_clicked()
{
